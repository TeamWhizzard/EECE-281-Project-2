...
main_weatherStateion.py - connects to WiFi and uploads local pictures from the previous day in /images/cameraImages/ to Imgur. Script then downloads sorted images from Imgur into /images/twitImages/. The weather data from arduino is then formatted into a report and posted to twitter.
